...
public class Caminos {
	...
	public void calcularListaMax(List<Integer> listaMax,List<Integer> listaAct, GeneralTree<Integer> nodo) {
		listaAct.add(nodo.getData());
		if (nodo.isLeaf()) {
			...
			for (GeneralTree<Integer> child: nodo.getChildren()) {
				calcularListaMax(listaMax, listaAct, child);
			}
		}
	...
	public List<Integer> caminoAHojaMasLejana() {
		...
		calcularListaMax(listaMax,listaAct,arbol);
		return listaMax;
	}
